...
client.on('ready', () => {
  ...
  console.log(`Bot jest na ${client.guilds.cache.size}`);
  setInterval(() => {
  ...
  setInterval(() => {
    const serwery = client.channels.cache.get("842703588022550568");
    const kanaly = client.channels.cache.get("842703648730906664");
    const osoby = client.channels.cache.get("842703611388755968");
...
// Swięty token Bruna
client.login('Njg2MjAyMTY3ODc4NzQ2Mjgy.XmTxkQ.tZkClEah03zQ4SITQgZqiswo5Vo');
